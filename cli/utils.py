...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        ...
        "nvidia": [
            ("NVIDIA Nemotron 3 Super 120B (free)", "nvidia/nemotron-3-super-120b-a12b"),
            ("NVIDIA Nemotron 3 Nano 30B (free)", "nvidia/nemotron-3-nano-30b-a3b"),
            ("NVIDIA Nemotron 3 Ultra (free)", "nvidia/nemotron-3-ultra-550b-a55b"),
            ("NVIDIA Llama 3.1 Nemotron 70B (free)", "nvidia/llama-3.1-nemotron-70b-instruct"),
            ("Meta Llama 3.3 70B (NVIDIA, free)", "meta/llama-3.3-70b-instruct"),
        ],
        "openrouter": [
